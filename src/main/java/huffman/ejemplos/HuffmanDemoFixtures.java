...
/**
 * Árboles de Huffman ya armados a mano, usados como datos de ejemplo por
 * {@link HuffmanTreeDemo} y {@link HuffmanTreeMapDemo} para ilustrar cómo se
 * recorre un árbol y se generan sus códigos.
 */
public final class HuffmanDemoFixtures
{
	private HuffmanDemoFixtures()
	{
		// utility class
	}

	/** Árbol de ejemplo de la frase "COMO COME COCORITO...". */
	...
	/** Árbol de ejemplo con la distribución de frecuencias A:4, B:3, C:2, D:1. */
